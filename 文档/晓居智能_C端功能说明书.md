...
晓居智能 C端产品是面向**终端消费者**的轻量级 Web 应用（后续将打包为微信小程序）。用户通过**扫描二维码**或**触碰 NFC 标签**两种方式进入系统，系统根据 URL 携带的 `code` 参数判断商家绑定状态，并引导用户完成注册或直接进入详情页。
...
*晓居智能 · C端产品功能说明书 v1.0 | 2026-08-03 | 适用于 AI 自动化功能测试*