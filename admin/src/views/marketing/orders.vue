      ...
      <div v-if="currentOrder" class="order-detail">
        <a-descriptions :column="1" bordered size="small">
          ...
          <a-descriptions-item label="支付方式">
            {{ { wechat: '微信支付', alipay: '支付宝', online: '在线支付' }[currentOrder.payType] || currentOrder.payType || '在线支付' }}
          </a-descriptions-item>
...
const columns = [
  ...
  { title: '下单时间', dataIndex: 'createTime', key: 'createTime', width: 180, customRender: ({ text }) => formatTime(text) },
