...
const _sfc_main = {
  ...
  computed: {
    uClasses() {
      ...
      if (this.color && common_vendor.config.type.includes(this.color)) classes.push("u-icon__icon--" + this.color);
      return classes;
    },
    iconStyle() {
      let style = {};
      ...
      if (this.color && !common_vendor.config.type.includes(this.color)) style.color = this.color;
      return style;
    },
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-1c933a9a"], ["__file", "/Users/liliusheng/Desktop/andre/quick-tap/miniapp/node_modules/uview-plus/components/u-icon/u-icon.vue"]]);
